...
1. 所在空间有2.4G无线wifi
2. 手机当前正连接该无线wifi（如果是2.4G 5G二合一 连接同名5Gwifi也可以）

如果无法成功，也可[通过 APP 将设备连接到 WiFi](./通过APP将设备连接到wifi.md)
...
输入当前手机连接的wifi密码（必须是2.4G或者2.4与5同名）
