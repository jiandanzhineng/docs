...
2.  Conecte todos los dispositivos a la red.
    - Referencia para teléfonos móviles: [**Cliente para móvil**](../../seniorPlayer/手机客户端（建议采用默认wifi，不要进行配网）.md)
    - Referencia para ordenadores: [**Cliente de control para PC**](../../seniorPlayer/PC版控制客户端.md)
