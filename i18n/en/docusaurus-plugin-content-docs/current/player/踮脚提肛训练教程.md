...
![Tiptoe and Kegel overview ##h40vh##](./img/tigang/tigang-en.png)

## Preparation

1. **Connect the Client**: First, install the APP and connect to the host. For details, refer to [Client Download and Device Connection](client/new-phone-client.md).
