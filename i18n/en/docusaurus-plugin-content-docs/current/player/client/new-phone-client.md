...
title: Client Download and Device Connection
sidebar_position: 1
---
...
2. Open the client, click "Add Device" or the plus sign in the top right corner.
   ![APP Homepage Screenshot ##h40vh##](./img/client/app.jpg)
3. Click "Add Device".
   ![Discover Device ##h40vh##](./img/client/finddevice.jpg)
4. Click "Complete".
   ![Add Device ##h40vh##](./img/client/adddevice.jpg)
5. At this point, the device has been successfully added and properly connected. After a successful connection, the blue light will stay on for a few seconds and then turn off.
   ![Finish ##h40vh##](./img/client/finish.jpg)