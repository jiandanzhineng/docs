...
**<font>Note: After the device connects to WiFi, it will automatically turn off Bluetooth. If it shows failure but re-searching does not find the device, then it has succeeded.</font>**
